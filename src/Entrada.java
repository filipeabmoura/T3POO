 ...
 * @author Hilario Seibel Junior e Bruno Plazzi e Filipe Moura
 */
public class Entrada {
     ...
     */
    private int lerInteiro(String msg) throws NumberFormatException {
     ...
     */
    private double lerDouble(String msg) throws NumberFormatException {
    ...
    */
    public int menu1() {
        // Imprime o menu principal, lê a opção escolhida pelo usu
        // ário e retorna a opção selecionada.
        ...
        try{
            ...
            System.out.println("ERRO! Digite um numero inteiro, correspondente a uma das opcoes.");
        }
    ...
    public void cadProf(Sistema s) {
        ...
        try{
            ...
            System.out.println("ERRO! Argumento invalido. Professor nao cadastrado.");
        }
    ...
    public void cadAluno(Sistema s) {
        ...
        try{
            ...
            System.out.println("ERRO! Argumento invalido. Aluno nao cadastrado.");
        }
    }
     ...
     */
    private Aluno[] lerAlunos(Sistema s) throws AlunosInsuficientesException {
        int nAlunos = this.lerInteiro("Digite a quantidade de alunos na disciplina: ");

        if(s.getnAlunos() < nAlunos){
            throw new AlunosInsuficientesException("Não há alunos suficientes para criar turma.");
        }
     ...
     */
    private Avaliacao[] lerAvaliacoes(Sistema s, Aluno[] alunos) throws NegativeArraySizeException {
     ...
     */
    public Turma cadTurma(Sistema s) throws IllegalArgumentException, StringIndexOutOfBoundsException, NumberFormatException, NaoHaProfsException, NaoHaAlunosException, AlunosInsuficientesException, NegativeArraySizeException {

        if(s.getnProfs() <= 0){

            throw new NaoHaProfsException("Para cadastrar uma turma, deve haver pelo menos um professor cadastrado no sistema.");

        }if(s.getnAlunos() <= 0) {

            throw new NaoHaAlunosException("Para cadastrar uma turma, deve haver pelo menos um aluno cadastrado no sistema.");
        }
